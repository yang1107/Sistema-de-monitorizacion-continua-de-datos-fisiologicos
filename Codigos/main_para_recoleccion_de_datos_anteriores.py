...
if len(sys.argv) == 4:
    ...
    while True:
        ...
        # comprobar si hay que parar
        # enddate_aux = int(enddate)
        if enddate >= time_to_stop:
            print('enddate ', enddate, type(enddate))
            print('time_to_stop ', time_to_stop, type(time_to_stop))
            print('ha llegado al tiempo de parada, paramos')
            break
        ...
        new_enddate = int(new_startdate) + 172800 # 4 horas
